        ...
        <div className="max-w-6xl grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex gap-4 flex-wrap">
              <a href="#projects" className="px-8 py-4 rounded-2xl bg-cyan-500 hover:bg-cyan-400 transition font-semibold text-black">
                View Projects
              </a>

              <a href="#contact" className="px-8 py-4 rounded-2xl border border-white/20 hover:border-cyan-400 hover:text-cyan-400 transition">
                Contact Me
              </a>
            </div>
          </div>
            ...
            {[
              {
                ...
                desc: 'A futuristic portfolio website with modern UI.',
              },
              {
                title: 'Engineering Dashboard',
                desc: 'Interactive dashboard with analytics.',
              },
              {
                title: 'AI Study Assistant',
                desc: 'Smart learning assistant project.',
              },
            ].map((project, index) => (
              <div key={index} className="group bg-black/40 border border-white/10 rounded-3xl overflow-hidden hover:border-cyan-400/50 transition duration-500">
      ...
      <section id="skills" className="py-24 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {['HTML', 'CSS', 'JavaScript', 'React', 'C++', 'Python', 'UI/UX', 'Problem Solving'].map((skill, index) => (
              <div key={index} className="bg-white/5 border border-white/10 rounded-2xl py-8 hover:scale-105 hover:border-cyan-400 transition duration-300">
      ...
      <section id="contact" className="py-24 px-6 bg-white/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6">
            <a href="mailto:yourmail@example.com" className="px-8 py-4 rounded-2xl bg-cyan-500 hover:bg-cyan-400 text-black font-bold transition">
              Email Me
            </a>

            <a href="https://github.com" target="_blank" className="px-8 py-4 rounded-2xl border border-white/20 hover:border-purple-400 hover:text-purple-400 transition">
              GitHub
            </a>
          </div>
        </div>
